...
if (input::get('submit')) {
  ...
  if ( token::check(input::get('token'))) {
      ...
      if ($user->cek_useradmin(input::get('username')))
      {
        
        if ($user->loginuser(input::get('username'), input::get('password'))) 
        {
          session::set('username', input::get('username'));
          echo "<script>location='index.php?halaman=homeadmin';</script>";
        ...
        <div class="card" style="padding: 30px; margin-top: 25%">
          <div class="card-body">
            ...
            <form method="post" class="form-signin" style="padding: 20px">
              ...
              <input type="submit" name="submit" class="btn btn-lg btn-primary btn-block text-uppercase" value="Login Sekarang">
